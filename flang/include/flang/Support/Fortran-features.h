...
// Note: When adding a new UsageWarning, add it to commonWarnings if it should
//       be enabled by -pedantic.
ENUM_CLASS(UsageWarning, Portability, PointerToUndefinable,
    ...
    // The below are deliberately not added to commonWarnings:
    // For F77 only:
    F77Warnings, SystemClockNotIntrinsic,
    // For F90 and F95:
    F90Warnings, F95Warnings, SystemClockArgsOnlyInteger,
    SystemClockIntArgsOnlyDefault,
    // For F2023 and later:
    F2023Warnings, SystemClockIntArgsSameKind, SystemClockMinSize)
...
// Usage Warnings that are to be turned on by -pedantic.
